...
```bash
curl -fsSLO https://raw.githubusercontent.com/voidvon/inbrix/v1.17.0/scripts/verify.sh
bash verify.sh --repo voidvon/inbrix --tag v1.17.0 inbrix_1.17.0_linux_amd64.zip
```
