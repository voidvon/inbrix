...
```bash
curl -fsSLO https://raw.githubusercontent.com/voidvon/inbrix/v1.17.18/scripts/verify.sh
bash verify.sh --repo voidvon/inbrix --tag v1.17.18 inbrix_1.17.18_linux_amd64.zip
```
