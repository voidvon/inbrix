...
```bash
curl -fsSLO https://raw.githubusercontent.com/voidvon/inbrix/v1.17.17/scripts/verify.sh
bash verify.sh --repo voidvon/inbrix --tag v1.17.17 inbrix_1.17.17_linux_amd64.zip
```
