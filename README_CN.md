...
```bash
curl -fsSLO https://raw.githubusercontent.com/voidvon/inbrix/v1.17.13/scripts/verify.sh
bash verify.sh --repo voidvon/inbrix --tag v1.17.13 inbrix_1.17.13_linux_amd64.zip
```
