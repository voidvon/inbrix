...
```bash
curl -fsSLO https://raw.githubusercontent.com/voidvon/inbrix/v1.17.15/scripts/verify.sh
bash verify.sh --repo voidvon/inbrix --tag v1.17.15 inbrix_1.17.15_linux_amd64.zip
```
