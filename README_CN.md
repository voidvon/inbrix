...
```bash
curl -fsSLO https://raw.githubusercontent.com/voidvon/inbrix/v1.17.1/scripts/verify.sh
bash verify.sh --repo voidvon/inbrix --tag v1.17.1 inbrix_1.17.1_linux_amd64.zip
```
