...
```bash
curl -fsSLO https://raw.githubusercontent.com/voidvon/inbrix/v1.17.3/scripts/verify.sh
bash verify.sh --repo voidvon/inbrix --tag v1.17.3 inbrix_1.17.3_linux_amd64.zip
```
