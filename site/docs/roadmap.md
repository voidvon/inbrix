...
>
> 📋 The concrete, checkbox-level breakdown lives in **[TASKS.md](https://github.com/vul-os/inbrix/blob/main/TASKS.md)**.
...
- Documentation gates in CI: every mounted `/v1` route must appear in
  [docs/API.md](api.md) with its method (and vice versa), and the AWS SigV4
...
- Emitting outbound webhooks. Clients read `/v1`, subscribe to SSE, or use Web
  Push — see [docs/SIGNING.md](signing.md).

Have an idea or want to pick something up? See
[Contributing](https://github.com/vul-os/inbrix/blob/main/README.md#contributing) and open an issue or PR.
