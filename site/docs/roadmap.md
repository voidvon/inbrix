...
>
> 📋 The concrete, checkbox-level breakdown lives in **[TASKS.md](https://github.com/vul-os/lilmail/blob/main/TASKS.md)**.
...
[Contributing](https://github.com/vul-os/lilmail/blob/main/README.md#contributing) and open an issue or PR.
