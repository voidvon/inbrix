export const zh = {
  ...
  aiRewritingDocument: "AI 正在改写…",
  aiDocumentRewritten: "文档已改写",
  ...
  copyMessage: "复制全部",
  copyMessageSuccess: "邮件内容已复制",
  copyMessageFailed: "复制邮件内容失败",
  copyEmail: "复制邮箱",
...
export const en = {
  ...
  documentType: "Type",
  documentCounterparty: "Counterparty",
  ...
  aiRewritingDocument: "AI is rewriting…",
  aiDocumentRewritten: "Document rewritten",
  ...
  copyMessageSuccess: "Email content copied",
  copyMessageFailed: "Could not copy email content",
